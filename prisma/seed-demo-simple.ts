...
async function main() {
  ...
  try {
    ...
    // Create demo vehicle with the demo QR code
    ...
    console.log(`  - Vehicle: ${demoVehicle.make} ${demoVehicle.model}`)
    console.log(`  - Service Records: ${demoServiceRecords.length}`)
    console.log(`  - Garages: ${garages.length}`)
    console.log(`  - Mechanics: ${demoMechanics.length}`)
    console.log(`  - Admin: ${demoAdmin.name}`)
    console.log(`  - QR Code: ${demoVehicle.qrCode}`)
