...
async function restartServices(): Promise<any> {
  try {
    ...
    try {
      ...
      results.pm2 = { status: 'error', error: error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : 'Unknown error' }
    }
    ...
    try {
      ...
      results.nginx = { status: 'error', error: error instanceof Error ? error.message : "Unknown error" }
    }
...
async function performHealthCheck(): Promise<any> {
  try {
    ...
    try {
      ...
      health.services.database = { status: 'unhealthy', error: error instanceof Error ? error.message : "Unknown error" }
    ...
    try {
      ...
      health.services.redis = { status: 'unhealthy', error: error instanceof Error ? error.message : "Unknown error" }
      health.status = 'unhealthy'
    }
    ...
    try {
      ...
      health.resources.disk = { status: 'unhealthy', error: error instanceof Error ? error.message : "Unknown error" }
      health.status = 'unhealthy'
    }
    ...
    try {
      ...
      health.resources.memory = { status: 'unhealthy', error: error instanceof Error ? error.message : "Unknown error" }
      health.status = 'unhealthy'
    }
...
async function performCleanup(): Promise<any> {
  try {
    const cleanup: any = {
      timestamp: new Date().toISOString(),
      logs: { deleted: 0, error: null },
      temp: { deleted: 0, error: null },
      cache: { deleted: 0, error: null },
      oldBackups: { deleted: 0, error: null }
    }
    ...
    try {
      ...
      cleanup.logs.error = error instanceof Error ? error.message : "Unknown error"
    }
    ...
    try {
      ...
      cleanup.temp.error = error instanceof Error ? error.message : "Unknown error"
    }
    ...
    try {
      ...
      cleanup.oldBackups.error = error instanceof Error ? error.message : "Unknown error"
    }
